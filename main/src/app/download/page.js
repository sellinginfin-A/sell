      ...
      <div className="min-h-screen bg-gray-900 relative">
        ...
        <div className="container mx-auto px-4 py-16">
            ...
            <div className="w-full max-w-5xl mx-auto text-center">
              ...
              <div className="mb-16">
                ...
                <p className="text-lg text-gray-400 max-w-3xl mx-auto mb-12">
                  Haven't purchased yet? <a href="/#services" className="text-blue-400 hover:underline font-medium">View our premium training programs</a>
                </p>
              </div>
                  ...
                  <form onSubmit={handleRedownload} className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-700 text-white placeholder-gray-400"
                        disabled={loading}
                      />
                    </div>
          ...
          <div className="mt-16 max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-gray-800 rounded-lg shadow-md border border-gray-700">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Secure Download</h3>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 rounded-2xl p-8 max-w-4xl mx-auto">
